        ...
        if(commandSender instanceof Player){
            ...
            if (strings[0].length() == 0) {
                if(p.hasPermission("staffutilities.fix")){
                    ...
                    p.sendMessage(Color.getColor(msg.getString("Messages.Prefix") + msg.getString("Messages.ItemFixed")));
                }else{
                ...
                if(strings[0].equalsIgnoreCase("fixall")){
                    if(p.hasPermission("staffutilities.fixall")) {
                        ...
                        p.sendMessage(Color.getColor(msg.getString("Messages.Prefix") + msg.getString("Messages.InventoryFixed")));
                    }
                }else{
                    p.sendMessage(Color.getColor(msg.getString("Messages.Prefix") + msg.getString("Messages.noPerms")));
                }
